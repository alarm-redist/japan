...
# Connect 旧大柿町(江田島市) with 呉市
prefadj <- geomander::add_edge(prefadj,
                               which(pref$code == 34215 &
                                       pref$pre_gappei_code == 34330),
                               which(pref$code == 34202))
...
# Merge 広島市安芸区(code: 34107) and 安芸郡(gun_code: 34300) to
# avoid creating discontiguous districts
pref_map$gun_code[which(pref_map$code == 34107 | pref_map$gun_code == 34300)] <-
  34300

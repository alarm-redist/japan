###############################################################################
# Co-occurrence analysis for `35_yamaguchi`
...
cities <- data.frame(longitude = c(131.47380, 130.94095),
                     latitude = c(34.17813, 33.95722),
                     names = c("Yamaguchi", "Shimonoseki"))
...
PAL <- c('#6D9537', '#9A9BB9', '#DCAD35', '#364B7F', '#2A4E45', '#7F4E28')
# Co-occurrence plot
ggplot() +
  ...
  geom_sf_text(data = cities, aes(label = names), size = 3,
               nudge_x = c(0.13, 0.13), # adjust the position of the labels
               nudge_y = c(0, -0.03), # adjust the position of the labels
               color = c("white", "black"),

###############################################################################
# Co-occurrence analysis for `12_chiba`
...
cities <- data.frame(longitude = c(140.106355, 139.982369, 139.975851),
                     ...
                     names = c("Chiba", "Funabashi", "Kashiwa"))
...
ggplot() +
  ...
  geom_sf_text(data = cities, aes(label = names), size = 3,
               ...
               nudge_x = c(-0.1, 0.1, 0.1), # adjust the position of the labels
               nudge_y = c(0, 0.035, 0.015), # adjust the position of the labels

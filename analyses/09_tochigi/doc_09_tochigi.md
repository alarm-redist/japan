# 2022 Redistricting for the House of Representatives Electoral Districts in Tochigi Prefecture
...
* We do not allow municipalities to be split except for those that were split in the 2017 or 2022 map: 宇都宮市 (Utsunomiya-shi), 栃木市 (Tochigi-shi), and 下野市 (Shimotsuke-shi). We allow these municipalities to be split along the boundaries of pre-merger municipalities.
* In addition, we do not allow counties (*gun*) to be split except for those that were split in the 2017 map. In the case of Tochigi, we do not allow any counties (*gun*) to be split. 

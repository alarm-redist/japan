...
ggplot() +
  ...
  geom_sf_text(data = cities, aes(label = names), color = "black", size = 3,
              nudge_x = c(-0.3, 0.35), # adjust the position of the labels
              nudge_y = c(0, 0.05), # adjust the position of the labels
...
redist::redist.plot.plans(sim_smc_pref_0_sample, optimal_0, pref_map_0) +
  ...
  geom_sf(data = cities, size = 2, shape = 21, fill = "red") +
  geom_sf_text(data = cities, aes(label = names), color = "black", size = 3,
              nudge_x = c(-35000, 40000), # adjust the position of the labels
              nudge_y = c(-5000, 8800), # adjust the position of the labels
              family = "HiraginoSans-W3") +
...
redist::redist.plot.plans(sim_smc_pref_1_sample, optimal_1, pref_map_1) +
  ...
  geom_sf(data = cities, size = 2, shape = 21, fill = "red") +
  geom_sf_text(data = cities, aes(label = names), color = "black", size = 3,
              nudge_x = c(-32000, 36000), # adjust the position of the labels
              nudge_y = c(-5000, 8800), # adjust the position of the labels
              family = "HiraginoSans-W3") +

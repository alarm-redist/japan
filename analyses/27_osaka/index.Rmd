...
ggplot() +
  ...
  geom_sf_text(data = cities, aes(label = names), size = 3,
              ...
              nudge_x = c(-15000, 4400, 6500, 8500, 
                          -5800, 7000, 6500, 8500, -5800), # adjust the position of the labels
              nudge_y = c(0, 0, 0, 0,
                          400, 0, 0, 0,-300), # adjust the position of the labels
              #大阪, 堺, 高槻, 東大阪, 
              #豊中, 枚方, 八尾, 寝屋川, 吹田

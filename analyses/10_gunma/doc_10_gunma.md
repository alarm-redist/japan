# 2022 Redistricting for the House of Representatives Electoral Districts in Gunma Prefecture
...
* We do not allow municipalities to be split except for those that were split in the 2017 or 2022 map: 高崎市 (Takasaki-shi), 桐生市 (Kiryu-shi), 太田市 (Ota-shi), 渋川市 (Shibukawa-shi), and みどり市 (Midori-shi). We allow these municipalities to be split along the boundaries of pre-merger municipalities.
* In addition, we do not allow counties (*gun*) to be split except for those that were split in the 2017 map. In the case of Gunma, we do not allow any counties (*gun*) to be split.

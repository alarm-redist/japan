# 2022 Redistricting for the House of Representatives Electoral Districts in Fukushima Prefecture
...
* We do not allow municipalities to be split except for those that were split in the 2017 or 2022 map. In the case of Fukushima, we do not allow any municipality to be split.
* In addition, we do not allow counties (*gun*) to be split except for those that were split in the 2017 map. In the case of Fukushima, we allow 西白河郡 (Nishishirakawa-gun) to be split along the boundaries of municipalities.

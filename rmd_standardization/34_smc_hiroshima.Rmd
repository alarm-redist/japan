...
koiki_split_2 <- 
  redist::redist.splits(pref_smc_plans_1, koiki_1_2) + 
  redist::redist.splits(pref_smc_plans_1, koiki_2_2) +
  redist::redist.splits(pref_smc_plans_1, koiki_3_2)
```
...
```
```{r}
functioning_results_2 <- results_2[which(results_2$contiguous == 1 & results_2$ferry_discontiguity == 0), ]

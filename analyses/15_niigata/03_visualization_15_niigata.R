###############################################################################
# Data visualization for `15_Niigata`
...
koiki_1_codes <- c(15101, 15102, 15103, 15104, 15105, 15106, 15107, 15108, 
                   15204, 15206, 15209, 15213, 15218, 15223, 15227, 15307, 
                   15342, 15361, 15385)
...
# Count number of gun splits, no gun splits in Niigata

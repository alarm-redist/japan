...
mainland_add_edge <-
  matrix(c(
    #大田区東海-大田区平和島
    which(mainland$code == 13111 & mainland$sub_code == 580),
    which(mainland$code == 13111 & mainland$sub_code == 90),
    #大田区東海-大田区京浜島
    which(mainland$code == 13111 & mainland$sub_code == 580),
    which(mainland$code == 13111 & mainland$sub_code == 600),
    #大田区昭和島-大田区大森東
    which(mainland$code == 13111 & mainland$sub_code == 100),
    which(mainland$code == 13111 & mainland$sub_code == 20),
    #大田区羽田空港-大田区京浜島
    which(mainland$code == 13111 & mainland$sub_code == 430),
    which(mainland$code == 13111 & mainland$sub_code == 600),
    #大田区羽田空港-大田区大森東
    which(mainland$code == 13111 & mainland$sub_code == 430),
    which(mainland$code == 13111 & mainland$sub_code == 20),
    #大田区羽田空港-大田区東糀谷
    which(mainland$code == 13111 & mainland$sub_code == 430),
    which(mainland$code == 13111 & mainland$sub_code == 380),
    #大田区羽田空港-大田区羽田旭町
    which(mainland$code == 13111 & mainland$sub_code == 430),
    which(mainland$code == 13111 & mainland$sub_code == 410),
    #大田区令和島-大田区城南島
    which(mainland$code == 13111 & mainland$sub_code == 811),
    which(mainland$code == 13111 & mainland$sub_code == 590),
    #大田区平和島-品川区勝島
    which(mainland$code == 13111 & mainland$sub_code == 90),
    which(mainland$code == 13109 & mainland$sub_code == 40),
    #品川区八潮-品川区東八潮
    which(mainland$code == 13109 & mainland$sub_code == 250),
    which(mainland$code == 13109 & mainland$sub_code == 270),
    #品川区八潮-品川区東大井
    which(mainland$code == 13109 & mainland$sub_code == 250),
    which(mainland$code == 13109 & mainland$sub_code == 160),
    #品川区八潮-品川区東品川
    which(mainland$code == 13109 & mainland$sub_code == 250),
    which(mainland$code == 13109 & mainland$sub_code == 180),
    #品川区東大井-品川区勝島
    which(mainland$code == 13109 & mainland$sub_code == 160),
    which(mainland$code == 13109 & mainland$sub_code == 40),
    #港区海岸-港区台場
    which(mainland$code == 13103 & mainland$sub_code == 20),
    which(mainland$code == 13103 & mainland$sub_code == 300)
  ), ncol = 2, byrow = TRUE)

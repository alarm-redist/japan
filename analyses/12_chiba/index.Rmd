...
ggplot() +
  ...
  geom_sf_text(data = cities, aes(label = names), size = 3,
              ...
              nudge_x = c(4000, 2000, 0), # adjust the position of the labels
              nudge_y = c(3000, 3000, -3000), # adjust the position of the labels
              #"千葉市", "船橋市", "柏市"
...
ggplot() +
  ...
  geom_sf_text(data = cities, aes(label = names), size = 3,
              ...
              nudge_x = c(0, 2000, 0), # adjust the position of the labels
              nudge_y = c(-3000, 3000, -3000), # adjust the position of the labels
              #"千葉市", "船橋市", "柏市"
              family = "HiraginoSans-W3") +
...
ggplot() +
  ...
  geom_sf_text(data = cities, aes(label = names), size = 3,
              ...
              nudge_x = c(8000, 2000, 0), # adjust the position of the labels
              nudge_y = c(-3000, 3000, -3000), # adjust the position of the labels
              #"千葉市", "船橋市", "柏市"
              family = "HiraginoSans-W3") +

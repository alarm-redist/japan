...
# The `suggest_component_connection` connects 壱岐市(42210) to the mainland in an incorrect way.
# We instead add edges between 壱岐市(42210) and the mainland manually.
...
prefadj <- geomander::add_edge(prefadj,
                               ...
                               which(pref$code == 42205)) #大村市
# In addition, under the enacted plan, 西海市(42212) and 旧佐世保市(42202) are considered
# to be contiguous, as those municipalities are connected via a bridge.
# Thus, we add an adjacency between 西海市(42212) and 旧佐世保市(42202) and
...
# For Nagasaki, it was impossible to increase the plan diversity further.

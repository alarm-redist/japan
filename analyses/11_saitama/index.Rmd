...
optimal_splits_name <- "さいたま市岩槻区、さいたま市北区、川口市、上尾市、狭山市、入間市、熊谷市、行田市"
...
ggplot() +
   ...
   geom_sf_text(data = cities, aes(label = names), size = 3,
              ...
              nudge_x = c(2000, 0, 0, 0), # adjust the position of the labels
              nudge_y = c(-2000, -4000, -5000, -2000), # adjust the position of the labels
              #"さいたま市", "川越市", "川口市", "越谷市"
              family = "HiraginoSans-W3") +
...
* 隣接する地域と同じ選挙区に属する傾向が強い地域同士の集まりを、k = 35 設定
* 読み取り方  
地図上の地域の色が
  + 同じ → 同じ選挙区に属する傾向が強い
...
ggplot() +
  ...
  geom_sf_text(data = cities, aes(label = names), size = 3,
              color = c("black", "black", "black", "black"),
              nudge_x = c(0, -4500, 0, 0), # adjust the position of the labels
              nudge_y = c(2000, -2500, -5000, -2000), # adjust the position of the labels
              #"さいたま市", "川越市", "川口市", "越谷市"
              family = "HiraginoSans-W3") +
  ggthemes::theme_map(base_family = "HiraginoSans-W3") +
  theme(legend.position = "right", legend.title = element_blank())

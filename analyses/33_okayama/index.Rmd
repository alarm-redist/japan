...
## Change order of color palette
PAL <- c('#7F4E28' , '#DCAD35', '#364B7F', '#9A9BB9', '#6D9537', '#7F4E28')
...
redist::redist.plot.plans(sim_smc_pref_0_sample, optimal_0, pref_map_0) +
  ...
  # add Kurashiki-shi
  geom_sf(data = kurashiki, fill = '#9A9BB9', color = "grey30", lwd = 0.4) + 
...
PAL <- c('#9A9BB9', '#364B7F', '#6D9537', '#DCAD35')
...
* 逐次モンテカルロ法(SMC)による2つの独立したシミュレーションにより、市区町村分割を許容しない案、最大市区町村の分割を許容する案をそれぞれ`r format(2 * nsims, big.mark = ",")`作成
* 以下の案を棄却し有効な案を選定
  + 飛び地が生じる案

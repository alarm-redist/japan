...
# For Fukuoka, 那珂川市 (40231) was created from 那珂川町 (40305) in 2018
# Thus, we will re-assign the new code to the shapefile
pref_shp_cleaned[which(pref_shp_cleaned$mun_code == 40305), ]$mun_code <- 40231
# Combine municipality code with sub-code

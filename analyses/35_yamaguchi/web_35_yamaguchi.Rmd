...
ggplot() +
  ...
  geom_sf_text(data = cities, aes(label = names), color = "black", size = 3,
              nudge_x = c(0.10), # adjust the position of the labels
              nudge_y = c(-0.04), # adjust the position of the labels
...
PAL <- c('#DCAD35','#364B7F', '#6D9537', '#DCAD35', '#9A9BB9', '#2A4E45', '#7F4E28')

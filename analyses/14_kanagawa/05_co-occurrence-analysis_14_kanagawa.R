###############################################################################
# Co-occurrence analysis for `14_kanagawa`
...
cities <- data.frame(longitude = c(139.634683, 139.703129, 139.373678, 139.672385),
                     latitude = c(35.450686, 35.530670, 35.571769, 35.281591),
                     names = c("Yokohama", "Kawasaki", "Sagamihara", "Yokosuka"))
...
ggplot() +
  ...
  geom_sf_text(data = cities, aes(label = names), size = 3,
               ...
               nudge_x = c(0.14, 0.06, -0.10, 0.05), # adjust the position of the labels
               nudge_y = c(0, 0.03, 0.02, 0.03), # adjust the position of the labels
...
# TODO
# Remove additional objects (for Kanagawa only)

...
ggplot() +
  ...
  geom_sf(data = cities, size = 2, shape = 21, fill = "red") +
  geom_sf_text(data = cities, aes(label = names), size = 3,
              color = c("white", "black", "black", "white"),
              nudge_x = c(0, 2000, 0, 0), # adjust the position of the labels
              nudge_y = c(-3000, 3000, -3000, 3000), # adjust the position of the labels
              #"さいたま市", "川越市", "川口市", "越谷市"
              family = "HiraginoSans-W3") +
...
ggplot() +
  ...
  geom_sf_text(data = cities, aes(label = names), size = 3,
              ...
              nudge_x = c(8000, 2000, 0, 0), # adjust the position of the labels
              nudge_y = c(-3000, 3000, -3000, 3000), # adjust the position of the labels
              #"さいたま市", "川越市", "川口市", "越谷市"
              family = "HiraginoSans-W3") +
  ggthemes::theme_map(base_family = "HiraginoSans-W3") +

...
# Since there are only 2 districts, it is not possible for a municipality to be
# split into more than 2 districts. Thus, a multi-split constraint is not applied.
...
# For Shimane, it was impossible to increase the pan diversity further.

...
new_mun_splits_name <- "" 
new_gun_splits_name <- ""
new_koiki_splits_name <- "こおりやま広域連携中枢都市圏"
split_1_name <- "いわき市"
...
PAL <- c('#364B7F', '#6D9537', '#7F4E28',  '#DCAD35', '#9A9BB9', '#2A4E45')
...
PAL <- c('#364B7F','#DCAD35', '#6D9537',  '#7F4E28',  '#2A4E45', '#9A9BB9')
...
ggplot() +
  ...
  geom_sf(data = cities, size = 2, shape = 21, fill = "red") +
  geom_sf_text(data = cities, aes(label = names), 
               color = c("black" ,"black", "black"), size = 3,
              nudge_x = c(-5000, -5000, -5000), # adjust the position of the labels
              nudge_y = c(-5000, -5000, -5000), # adjust the position of the labels
              family = "HiraginoSans-W3") +
...
* [**GitHub** : プログラムとコード](https://github.com/alarm-redist/japan)

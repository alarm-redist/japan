###############################################################################
# Download and prepare data for `10_gunma` analysis
...
ndists_old <- 5
pop_tol <- 0.20
lh_old_max_to_min <- 1.261
lh_old_mun_split <- 5
lh_old_gun_split <- 0
lh_old_koiki_split <- 0
lh_2022_max_to_min <- 1.155
lh_2022_mun_split <- 1
lh_2022_gun_split <- 0
lh_2022_koiki_split <- 0

# Split the municipalities that are split under the status quo
split_code <- c(10202, 10203, 10205, 10208, 10212)
# 高崎市、桐生市、太田市、渋川市、みどり市

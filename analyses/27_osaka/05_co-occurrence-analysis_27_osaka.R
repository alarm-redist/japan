###############################################################################
# Co-occurrence analysis for `27_osaka`
...
cities <- data.frame(longitude = c(135.501875, 135.482614, 135.617851,
                                   135.600944, 135.470060, 135.651217,
                                   135.601038, 135.628460, 135.516824),
                     latitude = c(34.693647, 34.573127, 34.846221,
                                  34.679043, 34.780924, 34.814489,
                                  34.626773, 34.765962, 34.759644),
                     names = c("Osaka", "Sakai", "Takatsuki",
                               "Higashiosaka", "Toyonaka", "Hirakata",
                               "Yao", "Neyagawa", "Suita"))
...
ggplot() +
  ...
  geom_sf_text(data = cities, aes(label = names), size = 3,
               ...
               nudge_x = c(-0.015, 0.05, 0.065, 0.085,
                           -0.05, 0.07, 0.065, 0.085, -0.05), # adjust the position of the labels
               nudge_y = c(0, 0, 0, 0,
                           0.004, 0, 0, 0,-0.003), # adjust the position of the labels
               # Osaka, Sakai, Takatsuki, Higashiosaka,
               # Toyonaka,  Hirakata, Yao, Neyagawa, Suita

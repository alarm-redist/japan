# 2022 Redistricting for the House of Representatives Electoral Districts in Ibaraki Prefecture
...
* We remove the areas corresponding to 霞ヶ浦 (Lake Kasumigaura), 北浦 (Lake Kitaura), and 涸沼 (Lake Hinuma) from the Census shapefile.

## Simulation Notes

* We sample 20,000 districting plans across 4 independent runs of the Sequential Monte Carlo (SMC) algorithm.
* We do not allow municipalities to be split except for those that were split in the 2017 or 2022 map: 水戸市 (Mito-shi), 下妻市 (Shimotsuma-shi), 笠間市 (Kasama-shi), 常陸大宮市 (Hitachiomiya-shi), and 小美玉市 (Omitama-shi). We allow these municipalities to be split along the boundaries of pre-merger municipalities.
* In addition, we do not allow counties (*gun*) to be split except for those that were split in the 2017 map. In the case of Ibaraki, we allow 東茨城郡 (Higashiibaraki-gun) to be split along the boundaries of municipalities.

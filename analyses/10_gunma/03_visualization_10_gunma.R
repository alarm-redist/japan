...
# Remove みどり市(10212) from the analysis
pref_0_without_discont <- pref_0_without_discont %>% filter(code %in% 10212 == FALSE)
pref_smc_plans_0_without_discont <- pref_smc_plans_0[-which(pref_0$code == 10212),]
...
# Remove みどり市(10212)from the analysis
pref_1_without_discont <- pref_1_without_discont %>% filter(code %in% 10212 == FALSE)
pref_smc_plans_1_without_discont <- pref_smc_plans_1[-which(pref_1$code == 10212),]

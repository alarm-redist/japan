...
ggplot() +
  ...
  geom_sf_text(data = cities, aes(label = names), color = "black", size = 3,
              nudge_x = c(0, 0.10), # adjust the position of the labels
              nudge_y = c(-0.04, 0), # adjust the position of the labels
...
ggplot() +
  ...
  geom_sf(data = cities, size = 2, shape = 21, fill = "red") +
  geom_sf_text(data = cities, aes(label = names), color = "black", size = 3,
               nudge_x = c(0, 10000), # adjust the position of the labels
               nudge_y = c(-7500, 0), # adjust the position of the labels
               family = "HiraginoSans-W3") +

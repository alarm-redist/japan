###############################################################################
# Post-processing for `14_kanagawa`
# © ALARM Project, April 2023
###############################################################################

# TODO Define the koiki-renkei areas (広域連携)
# Define using gun_code if gun was merged
# There are no koiki-renkei areas in Kanagawa
...
# There are no koiki_renkei areas in Kanagawa
...
# add those areas
# Although 川崎市麻生区 has a discontiguous area (川崎市麻生区岡上), both the newly
# enacted plan and the map used prior to the current redistricting cycle treat that
# part as if it were contiguous to the main part of 川崎市麻生区.
# Therefore, we treat 川崎市麻生区岡上 in the same way as the enacted plans.

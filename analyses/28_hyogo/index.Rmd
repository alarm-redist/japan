...
cities <- data.frame(longitude = c(135.195794, 134.685579, 135.341088, 134.7675993953388, 134.54966094250287, 134.91488779579626), 
                     latitude = c(34.689840, 34.814940, 34.737914, 35.404501366177385, 35.00442758156127, 34.439684490682886),
                     names = c("Kobe", "Himeji", "Nishinomiya", "Yabu", "Shiso", "Awaji"))
...
ggplot() +
  ...
  geom_sf_text(data = cities, aes(label = names), size = 3,
              color = c("black", "black", "white", "black", "white", "black"),
              nudge_x = c(0, 0, -7500, -5000, 0, 12500), # adjust the position of the labels
              nudge_y = c(-10000, -10000, 7500, -7500, 7500,0), # adjust the position of the labels
              #"Kobe", "Himeji", "Nishinomiya", "Yabu", "Shiso", "Awaji"

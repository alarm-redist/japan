...
block_codes <- list(part_codes[which(part_codes <= 14120)],
                    part_codes[which(part_codes >= 14120 & part_codes <= 14140)],
                    part_codes[which(part_codes >= 14150)])
...
for(i in 1:1) {
  ...
  pref_part <- dplyr::bind_rows(small_units %>% dplyr::filter(code %in% largest_x & code %in% c(block_codes[[i]], block_codes[[i+1]], block_codes[[i+2]])),
                                pref_block %>% dplyr::filter(!(code %in% largest_x) & code %in% c(block_codes[[i]], block_codes[[i+1]], block_codes[[i+2]])))
  ...
  block_codes <- c(rep(1, length(which(part_codes <= 14120))),
                   rep(2, length(which(part_codes >= 14120 & part_codes <= 14140))),
                   rep(3, length(which(part_codes >= 14150 & part_codes <= 14160))),
                   rep(4, length(which(part_codes >= 14160))))

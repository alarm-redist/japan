###############################################################################
# Post-processing for `07_fukushima`
# © ALARM Project, April 2023
###############################################################################

# TODO Define the koiki-renkei areas (広域連携)
# Define using gun_code if gun was merged
koiki_1_codes <- c(7203, 7207, 7210, 7211, 7214,
                   7320, 7340, 7400, 7500, 7520)
koiki_2_codes <- c(7205, 7461, 7464, 7465, 7466, 7480)
koiki_3_codes <- c(7208, 7400)
koiki_4_codes <- c(7212, 7560)
koiki_5_codes <- c(7480)

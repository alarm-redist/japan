...
ggplot() +
  ...
  geom_sf_text(data = cities, aes(label = names), size = 3,
              ...
              nudge_x = c(0, 2000, 3000), # adjust the position of the labels
...
ggplot() +
  ...
  geom_sf_text(data = cities, aes(label = names), size = 3,
              ...
              nudge_x = c(-2000, 2000, 3000), # adjust the position of the labels
...
ggplot() +
  ...
  geom_sf_text(data = cities, aes(label = names), size = 3,
              color = c("black", "black", "black"),
              nudge_x = c(4500, 2000, 3000), # adjust the position of the labels

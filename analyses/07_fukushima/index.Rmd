...
table_summary <- dplyr::tribble(
  ...
  "郡の分割", sq_gun_splits, new_gun_split, sim_gun_split, 
  "広域連携地域の分割", sq_koiki_splits, new_koiki_split,  results_0_sample[which(results_0_sample$index == optimal_0),]$koiki_split
) 

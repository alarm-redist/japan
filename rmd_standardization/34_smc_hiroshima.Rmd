...
###For Hiroshima Only: As a result of splitting Fukuyama-shi, Utsumi-cho, Fukuyama-shi appears to be disconnected from the mainland. To fix this, we must add an adjacency edge between Utsumi-cho(34481) and Numakuma-cho(34482)
```{r}
prefadj_1 <- geomander::add_edge(prefadj_1, 

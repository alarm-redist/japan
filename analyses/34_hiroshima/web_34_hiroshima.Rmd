...
ggplot() +
  ...
  geom_sf_text(data = cities, aes(label = names), color = "black", size = 3,
              nudge_x = c(-6000, 0, 0), # adjust the position of the labels
...
redist::redist.plot.plans(sim_smc_pref_0, optimal_0, pref_map_0) +
  ...
  geom_sf_text(data = cities, aes(label = names), size = 3,
              nudge_x = c(-5000, 0, 0), # adjust the position of the labels
              nudge_y = c(5600, 5000, 5000), # adjust the position of the labels
...
redist::redist.plot.plans(sim_smc_pref_1, optimal_1, pref_map_1) +
  ...
  geom_sf_text(data = cities, aes(label = names), size = 3,
              nudge_x = c(-5000, 0, 0), # adjust the position of the labels
              nudge_y = c(5500, -4000, 5000), # adjust the position of the labels
              color = c("white", "black", "black"),
              family = "HiraginoSans-W3") +
...
PAL <- c('#2A4E45', '#7F4E28', '#364B7F',  '#9A9BB9', '#DCAD35', '#6D9537')

###############################################################################
# Co-occurrence analysis for `04_miyagi`
...
cities <- data.frame(longitude = c(140.869018),
                     latitude = c(38.268049),
                     names = c("Sendai"))
...
ggplot() +
  ...
  geom_sf_text(data = cities, aes(label = names), size = 3,
               nudge_x = -0.12, # adjust the position of the labels
               nudge_y = 0, # adjust the position of the labels
               color = "black",

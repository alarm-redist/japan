...
constr = redist::add_constr_splits(constr, strength= 20)
constr = redist::add_constr_multisplits(constr, strength = 100)
...
matrix_optimal <- redist::get_plans_matrix(pref_smc %>% filter(draw == optimal))
